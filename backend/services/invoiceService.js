...
/**
 * Generate a booking invoice PDF and return it as a Buffer.
 * Useful for emailing as an attachment.
 * @param {Object} booking - Populated booking document
 * @returns {Promise<Buffer>} - Resolves with the PDF Buffer
 */
export function generateInvoicePDFBuffer(booking) {
    return new Promise((resolve, reject) => {
        try {
            ...
            const col1 = 50, col2 = 180, col3 = 310, col4 = 410, rowH = 14;
